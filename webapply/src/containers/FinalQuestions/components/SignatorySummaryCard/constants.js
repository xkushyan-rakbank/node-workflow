...
export const signatoriesSteps = [
  {
    ...
    event_name: events.FINAL_QUESTION_PERSONAL_INFORMATION_CONTINUE
  },
  {
    step: STEP_2,
    title: "Employment details",
    component: SignatoryEmploymentDetails,
    event_name: events.FINAL_QUESTION_EMPLOYMENT_CONTINUE
  },
  {
    step: STEP_3,
    title: "Source of funds",
    component: SignatorySourceOfFunds,
    event_name: events.FINAL_QUESTION_SOURCE_OF_FUND_CONTINUE
  },
  {
    step: STEP_4,
