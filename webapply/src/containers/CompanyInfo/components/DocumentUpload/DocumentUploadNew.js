...
export const DocumentUpload = ({ values, setFieldValue, touched, setTouched }) => {
  ...
  const handleMOAFileDrop = (acceptedFiles, index) => {
    handleDropFile(acceptedFiles, `moa[${index}]`, touched, setTouched, setFieldValue, index);
  };
                  ...
                  return (
                    <div key={index} style={{ marginTop: "21px" }} data-testid="moaWrapperDiv">
                      <Field
                        ...
                        onDrop={acceptedFile => handleMOAFileDrop(acceptedFile, index)}
