...
import { docuploadDetails } from "../../store/actions/uploadProspectDocument";
  ...
  fileUploadHandler(event) {
    ...
    this.setState(
      ...
      () => {
        ...
        this.props.docuploadDetails(docDetails);
      }
    );
  }
        ...
        {this.state.enableUpload ? (
          ...
          <>
            ...
            <div className={this.props.classes.contentBox}>
              ...
              {this.state.isUploadSuccess ? null : (
                <div className={this.props.classes.uploadFileName}>
...
const mapDispatchToProps = dispatch => ({
  docuploadDetails: data => dispatch(docuploadDetails(data))
});
